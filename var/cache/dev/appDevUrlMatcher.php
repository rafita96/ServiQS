...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\RedirectController::urlRedirectAction',  'path' => '/categoria/Comida_Del_Dia',  'permanent' => true,  '_route' => 'heysoft_menu_homepage',);
        }

        if (0 === strpos($pathinfo, '/ca')) {
            // categoria
            if (0 === strpos($pathinfo, '/categoria') && preg_match('#^/categoria/(?P<nombre>[^/]++)$#s', $pathinfo, $matches)) {
